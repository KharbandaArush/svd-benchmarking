...
object SymmetricRandomMatrix {
  ...
  def main(args: Array[String]) {
    ...
    sc.hadoopConfiguration.set("fs.s3.awsAccessKeyId", System.getProperty("AWS_ACCESS_KEY"))
    sc.hadoopConfiguration.set("fs.s3.awsSecretAccessKey", System.getProperty("AWS_SECRET_ACCESS_KEY"))
